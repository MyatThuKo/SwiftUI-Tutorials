...
let fruitData: [Fruit] = [
    Fruit(
        ...
        description: """
          ...
          Blueberries are usually prostrate shrubs that can vary in size from 10 centimeters (3.9 in) to 4 meters (13 ft) in height. In the commercial production of blueberries, the species with small, pea-size berries growing on low-level bushes are known as "lowbush blueberries" (synonymous with "wild"), while the species with larger berries growing on taller cultivated bushes are known as "highbush blueberries".

          Canada is the leading producer of lowbush blueberries, while the United States produces some 40% of the world's supply of highbush blueberries.
          ...
          Generally, the nutrient contents of blueberries are a low percentage of the DV (table). One serving provides a relatively low caloric value of 57 kcal with a glycemic load of 6.
          """,
    ...
    Fruit(
        ...
        description: """
          ...
          In the United Kingdom, "strawberries and cream" is a popular dessert consumed at the Wimbledon tennis tournament.[5] Strawberries and cream are also a staple snack in Mexico, usually available at ice cream parlors. In Sweden, strawberries are a traditional dessert served on St John's Day, also known as Midsummer's Eve. Depending on the area, strawberry pie, strawberry rhubarb pie, or strawberry shortcake are also common. In Greece, strawberries may be sprinkled with sugar and then dipped in Metaxa, a brandy, and served as a dessert. In Italy, strawberries are used for various desserts and as a common flavoring for gelato (gelato alla fragola).

          Suonenjoki in North Savonia, Finland is a famous small town for its strawberries, that's why is also known as "the Strawberry Town" or "the Strawberry Capital". Lots of foreign people, mainly from Ukraine and Russia, come to Suonenjoki in the summer to work on strawberry farms. That makes Suonenjoki the most international town in Finland in the summer. There is a party in Suonenjoki in July called Mansikkakarnevaalit, "Strawberry Carnival".
          ...
          Strawberries contain a modest amount of essential unsaturated fatty acids in achene (seed) oil.
          """,
    ...
    Fruit(
        ...
        description: """
          The lemon, Citrus limon, is a species of a small evergreen tree in the flowering plant family Rutaceae, native to South Asia, primarily Northeastern India. Its fruits are round in shape.
          ...
          The leaves of the lemon tree are used to make tea and for preparing cooked meats and seafood.
          """,
    ...
    Fruit(
        ...
        description: """
          ...
          Plums are a diverse group of species. The commercially important plum trees are medium-sized, usually pruned to 5–6 meters in height. The tree is of medium hardiness. Without pruning, the trees can reach 12 meters in height and spread across 10 meters. They blossom in different months in different parts of the world; for example, in about January in Taiwan and early April in the United Kingdom.
    ...
    Fruit(
        ...
        description: """
        A lime (from French lime, from Arabic līma, from Persian līmū, "lemon")[1] is a citrus fruit, which is typically round, green in color, 3–6 centimeters (1.2–2.4 in) in diameter, and contains acidic juice vesicles.
          ...
          CULTIVATION
          Limes have higher contents of sugars and acids than lemons do.[2] Lime juice may be squeezed from fresh limes, or purchased in bottles in both unsweetened and sweetened varieties. Lime juice is used to make limeade, and as an ingredient (typically as a sour mix) in many cocktails.
          ...
          The use of dried limes (called black lime or loomi) as a flavoring is typical of Persian cuisine and Iraqi cuisine, as well as in Persian Gulf-style baharat (a spice mixture that is also called kabsa or kebsa).
    ...
    Fruit(
        ...
        description: """
          ...
          The tree is medium-sized and native to coastal as well as mildly temperate regions of Europe, North Africa, and Asia. Pearwood is one of the preferred materials in the manufacture of high-quality woodwind instruments and furniture.
          ...
          The leaves are alternately arranged, simple, 2–12 centimeters (1–4 1⁄2 in) long, glossy green on some species, densely silvery-hairy in some others; leaf shape varies from broad oval to narrow lanceolate. Most pears are deciduous, but one or two species in southeast Asia are evergreen.
          ...
          A species is grown in western China, P. sinkiangensis, and P. Pashia, grown in southern China and South Asia, are also produced to a lesser degree.

          Other species are used as rootstocks for European and Asian pears and as ornamental trees. Pearwood is close-grained and at least in the past was used as a specialized timber for fine furniture and making the blocks for woodcuts. The Manchurian or Ussurian Pear, Pyrus ussuriensis (which produces unpalatable fruit) has been crossed with Pyrus communis to breed hardier pear cultivars.
    ...
    Fruit(
        ...
        description: """
          ...
          The watermelon is a large annual plant with long, weak, trailing, or climbing stems that are five-angled (five-sided) and up to 3 m (10 ft) long. Young growth is densely woolly with yellowish-brown hairs which disappear as the plant ages. The leaves are large, coarse, hairy pinnately-lobed, and alternate; they get stiff and rough when old. The plant has branching tendrils.
          ...
          Lack of pollen is thought to contribute to a "hollow heart" which causes the flesh of the watermelon to develop a large hole, sometimes in an intricate, symmetric shape. Watermelons suffering from the hollow hearts are safe to consume.
          """,
    ...
    Fruit(
        ...
        description: """
          ...
          Grapefruit mercaptan, a sulfur-containing terpene, is one of the aroma compounds influencing the taste and odor of grapefruit, compared with other citrus fruits.
    ...
    Fruit(
        ...
        description: """
          ...
          The apple is a deciduous tree, generally standing 2 to 4.5 m (6 to 15 ft) tall in cultivation and up to 9 m (30 ft) in the wild. When cultivated, the size, shape, and branch density are determined by the rootstock selection and trimming method. The leaves are alternately arranged dark green-colored simple ovals with serrated margins and slightly downy undersides.

          Blossoms are produced in spring simultaneously with the budding of the leaves and are produced on spurs and some long shots. The 3 to 4 cm (1 to 1 1⁄2 in) flowers are white with a pink tinge that gradually fades, five-petaled, with an inflorescence consisting of a cyme with 4–6 flowers. The central flower of the inflorescence is called the "king bloom"; it opens first and can develop a larger fruit.

          CULTIVATION

          There are more than 7,500 known cultivars of apples.[44] Cultivars vary in their yield and the ultimate size of the tree, even when grown on the same rootstock.[45] Different cultivars are available for temperate and subtropical climates. The UK's National Fruit Collection, which is the responsibility of the Department of Environment, Food, and Rural Affairs, includes a collection of over 2,000 cultivars of apple trees in Kent.
